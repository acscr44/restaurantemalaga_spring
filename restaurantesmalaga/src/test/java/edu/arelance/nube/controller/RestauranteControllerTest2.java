...
public class RestauranteControllerTest2 {
	...
	public void getServicioMockeado() throws Exception {
		...
		//programamos el funcionamiento del mock, donde vemos que simulamos el comportamiento del service
		// devolviendo el objeto que devolvería nuestro service auntentico. 
		// Estamos aislando a nivel de controlador.
